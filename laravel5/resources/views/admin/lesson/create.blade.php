				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="input-group" style="margin-top:5px;">
							<img src="{{asset('admin/images/nopic.jpg')}}" class="img-responsive img-thumbnail" width="150">
						  ...
						  <div class="panel-body">
							  ...
							  <div class="form-group">
								  ...
								  <div class="progress" :id="'progress'+v.id" style="display: none">
									  <div class="progress-bar" :id="'progress-bar'+v.id" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 0%;">
										  0%
									  </div>
								  </div>
							  </div>
