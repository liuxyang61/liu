			...
			<div class="panel panel-default">
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="86">
                        <a href="{{u('admin.category.index')}}">栏目首页</a>
                    </li>
                    <li class="list-group-item" id="86">
...
<!--                文章功能-->
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="86">
                        <a href="{{u('admin.article.index')}}">文章首页</a>
                    </li>
                    <li class="list-group-item" id="86">
                        <a href="{{u('admin.article.post')}}">添加文章</a>
                    </li>
                </ul>
                <!--轮播图功能-->
                <div class="panel-heading">
                    <h4 class="panel-title">轮播图功能</h4>
                    <a class="panel-collapse" data-toggle="collapse" href="javascript:;">
                        <i class="fa fa-chevron-circle-down"></i>
                    </a>
                </div>
                <ul class="list-group menus">
                    <li class="list-group-item" id="86">
                        <a href="{{u('admin.slide.index')}}">轮播图列表</a>
                    </li>
                    <li class="list-group-item" id="86">
                        <a href="{{u('admin.slide.post')}}">轮播图添加</a>
                    </li>
                </ul>
