...
<!--头部结束-->
<!--body内容-->
<body class="site" ng-controller="ctrl">
...
<!--                微信功能-->
                ...
                <ul class="list-group menus">
                    <li class="list-group-item" id="86">
                        <a href="{{u('wechat.weixin.index')}}">微信配置</a>
                    </li>
                </ul>
                <div class="panel-heading">
                    <h4 class="panel-title">基本消息管理</h4>
                    <a class="panel-collapse" data-toggle="collapse" href="javascript:;">
                        <i class="fa fa-chevron-circle-down"></i>
                    </a>
                </div>
                <ul class="list-group menus">
                <li class="list-group-item" id="86">
                    <a href="{{url('base.index','base')}}">关键词回复</a>
                </li>
                    <li class="list-group-item" id="86">
                        <a href="{{url('moren.index','base')}}">默认回复</a>
                    </li>
                </ul>
                <div class="panel-heading">
                    <h4 class="panel-title">微信菜单管理</h4>
                    <a class="panel-collapse" data-toggle="collapse" href="javascript:;">
                        <i class="fa fa-chevron-circle-down"></i>
                    </a>
                </div>
                <ul class="list-group menus">
                    <li class="list-group-item" id="86">
                        <a href="{{url('button.index','button')}}">菜单列表</a>
                    </li>
                    <li class="list-group-item" id="86">
                        <a href="{{url('button.post','button')}}">菜单添加</a>
                    </li>
                </ul>
